package com.youhyun.jbc.template;
...
import com.youhyun.jdbc.raw.Article;
import com.youhyun.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/youhyundb?user=youhyun&password=youhyun");
